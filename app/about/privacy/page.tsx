    ...
    <div className="mx-auto max-w-4xl p-6">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="mb-4 list-disc pl-6">
            <li>
              您主动提供的个人信息（如注册信息：账号）。注意：密码是 Hash
              存储，并非明文，只做登录对比，请放心。
            </li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">我们收集的账户和 IP 地址，这两个信息分别仅用于以下目的：</p>
          <ul className="mb-4 list-disc pl-6">
            <li>让您正常登录网站。</li>
            <li>保障网站安全。</li>
          </ul>
        ...
        <section className="mb-8">
          ...
          <ul>
            <li>
              根据「信息收集」条目的说明，您账号和后续的网站功能使用中，请勿使用私密的字眼以及图片，那么信息不会造成不安全的隐患。
            </li>
            <li>
              因为，本网站是学习、测试用，所以，本网站更新和维护的频率很快。服务器环境（LNMP、Reids
              等），还有 NPM、Composer 包等，都会及时更新。
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            如果该网站存在漏洞，Chrome
            等浏览器提示红色危险警告，或者网站内容涉及非法字眼，请及时关闭该网站，如果您有时间，页可以帮忙举报下，避免其他用户访问到。
          </p>
        </section>
