    ...
    <div className="mx-auto max-w-4xl p-6">
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul>
            <li>
              根据「信息收集」条目的说明，您账号名称和后续的网站功能使用中，请勿使用私密的字词以及图片，那么信息则不会造成太大的安全隐患。
            </li>
            <li>
              因为本网站是学习和测试用，所以网站更新和维护的频率很快，比如：服务器环境（LNMP、Reids
              等），还有 NPM 包、Composer 包等，都会及时更新，以保证最大限度地保护您的隐私。
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            本网站未来可能包含第三方服务的链接。比如，其他公司的技术文档链接等，这些我们不对这些第三方的隐私做任何保证。如需访问，请参见第三方服务的隐私政策。
            当然，除非有漏洞，否则本网站的链接都是经本人使用过的网站，不会有太大的风险。
          </p>
        </section>
