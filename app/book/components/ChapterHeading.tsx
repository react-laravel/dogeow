import { splitChapterHeading } from '@/app/book/utils/bilingualParse'
import type { ReaderContentMode, ReaderFont } from '@/app/book/types/reader'
...
export function ChapterHeading({
  ...
  const originalFont = getBookFontFamily(originalFontFamily)
  const translationFont = getBookFontFamily(translationFontFamily)
