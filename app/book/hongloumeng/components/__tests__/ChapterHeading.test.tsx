...
// Mock the useReaderSettings hook
vi.mock('../../hooks/useReaderSettings', () => ({
  getReaderFontFamily: (font: string) => font,
  READER_FONT_LABELS: {
    serif: '宋体',
    'sans-serif': '黑体',
    kaiti: '楷体',
...
// Mock parseBook utils
vi.mock('../../utils/parseBook', () => ({
...
describe('ChapterHeading', () => {
  const defaultProps = {
    ...
    originalFontFamily: 'serif' as const,
    translationFontFamily: 'sans-serif' as const,
  }
  ...
  it('renders inline-grid when prefix is present in both mode', () => {
    ...
    // The component should render an inline-grid
  ...
  it('renders div wrapper when no prefix in both mode', () => {
    ...
    // Should render a div with space-y-2
  ...
  it('applies font family styles', () => {
    ...
    expect(h1).toHaveStyle({ fontFamily: 'serif' })
  })
})
