...
export function OllamaPanel() {
  const { ollamaAccessModeSelection, setOllamaAccessModeSelection } = useOllamaAccessMode()
  const { browserOllamaAddress, setBrowserOllamaAddress, resetBrowserOllamaAddress } =
    useBrowserOllamaAddress()
          ...
          return (
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="block text-sm font-medium">{getOllamaAccessModeLabel(mode)}</span>
