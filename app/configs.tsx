...
const SYSTEM_BACKGROUNDS = [
  ...
  { id: 'bg2', nameKey: 'background.bg2', url: '钢铁侠.jpg' },
...
export const configs = {
  ...
  books: [
    ...
    },
    {
      ...
      nameKey: 'book.luxun',
      descriptionKey: 'book.luxun.desc',
      href: '/book/luxun',
      color: '#4a6741',
      icon: '📚',
    ...
    },
    {
      ...
      descriptionKey: 'book.annakarenina.desc',
    ...
    },
    {
      id: 'biancheng',
      kind: 'volume' as const,
      nameKey: 'book.biancheng',
      descriptionKey: 'book.biancheng.desc',
      href: '/book/biancheng',
      color: '#2f6f6a',
      icon: '🛶',
      chapterSelectPlaceholder: '选择章节',
    ...
    },
    {
      id: 'sishitongtang',
      kind: 'volume' as const,
      nameKey: 'book.sishitongtang',
      descriptionKey: 'book.sishitongtang.desc',
      href: '/book/sishitongtang',
      color: '#8b4513',
      icon: '🏡',
      chapterSelectPlaceholder: '选择章节',
      fallbackTitle: '四世同堂',
    },
    {
      id: 'hongyan',
      kind: 'volume' as const,
      nameKey: 'book.hongyan',
      descriptionKey: 'book.hongyan.desc',
      href: '/book/hongyan',
      color: '#b71c1c',
      icon: '🪨',
      chapterSelectPlaceholder: '选择章节',
    ...
    },
    {
      id: 'pingfandeshijie',
      kind: 'volume' as const,
      nameKey: 'book.pingfandeshijie',
      descriptionKey: 'book.pingfandeshijie.desc',
      href: '/book/pingfandeshijie',
      color: '#c4a35a',
      icon: '🌾',
      chapterSelectPlaceholder: '选择章节',
      fallbackTitle: '平凡的世界',
    },
    {
      ...
      kind: 'volume' as const,
      nameKey: 'book.leiyu',
      descriptionKey: 'book.leiyu.desc',
      href: '/book/leiyu',
      color: '#4a148c',
      icon: '⚡',
      chapterSelectPlaceholder: '选择幕次',
      fallbackTitle: '雷雨',
    },
    {
      id: 'balishengmuyuan',
      kind: 'volume' as const,
      nameKey: 'book.balishengmuyuan',
      descriptionKey: 'book.balishengmuyuan.desc',
      href: '/book/balishengmuyuan',
      color: '#3e2723',
      icon: '⛪',
      chapterSelectPlaceholder: '选择章节',
      fallbackTitle: '巴黎圣母院',
    },
    {
      id: 'laorenyuhai',
      kind: 'volume' as const,
      nameKey: 'book.laorenyuhai',
      descriptionKey: 'book.laorenyuhai.desc',
      href: '/book/laorenyuhai',
      color: '#1565c0',
      icon: '🎣',
      chapterSelectPlaceholder: '选择章节',
      fallbackTitle: '老人与海',
    },
    {
      id: 'ouyenigelangtai',
      kind: 'volume' as const,
      nameKey: 'book.ouyenigelangtai',
      descriptionKey: 'book.ouyenigelangtai.desc',
      href: '/book/ouyenigelangtai',
      color: '#bf8c2f',
      icon: '💰',
      chapterSelectPlaceholder: '选择章节',
      fallbackTitle: '欧也妮·葛朗台',
    },
    {
      id: 'lunyu',
      kind: 'volume' as const,
      nameKey: 'book.lunyu',
      descriptionKey: 'book.lunyu.desc',
      href: '/book/lunyu',
      color: '#212121',
      icon: '📜',
      chapterSelectPlaceholder: '选择篇目',
    ...
    },
    {
      id: 'sanguoyanyi',
      kind: 'volume' as const,
      nameKey: 'book.sanguoyanyi',
      descriptionKey: 'book.sanguoyanyi.desc',
      href: '/book/sanguoyanyi',
      color: '#6d4c41',
      icon: '🗡️',
      chapterSelectPlaceholder: '选择回目',
      fallbackTitle: '三国演义',
    },
  ],
